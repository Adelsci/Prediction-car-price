...
Car_listings = pd.read_csv('C:/Users/user/OneDrive/Desktop/Project/true_car_listings.csv')
...
geo_data = pd.read_csv('C:/Users/user/OneDrive/Desktop/Project/uscities.csv')
